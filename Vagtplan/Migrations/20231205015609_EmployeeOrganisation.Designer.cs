...
namespace Vagtplan.Migrations
{
    ...
    [Migration("20231205015609_EmployeeOrganisation")]
    partial class EmployeeOrganisation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vagtplan.Models.Employee", b =>
                {
                    ...
                    b.HasOne("Vagtplan.Models.Organisation", null)
                        .WithOne("Owner")
                        .HasForeignKey("Vagtplan.Models.Employee", "OrganisationId1");
